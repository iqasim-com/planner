...
const ToSubmittal: FC<Props> = ({
  ...
  return (
    <Link
      to='/projects/PIM/project/overview/days/day/coordination/submittals/overview'
      className='card border border-2 bg-gray-100 border-gray-300 border-hover'
    >
