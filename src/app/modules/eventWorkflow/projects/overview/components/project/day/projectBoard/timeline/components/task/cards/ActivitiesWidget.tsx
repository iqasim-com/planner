  ...
  return (
    <>
      <div className='d-flex flex-wrap flex-stack mb-6'>
        <h3 className='fw-bolder my-2'>Planning Timeline</h3>
        ...
        <div className='d-flex my-2'>
          <select
            ...
            defaultValue='Online'
          >
            <option value='Online'>Planning</option>
            <option value='Pending'>Day-of</option>
            <option value='Declined'>Templates</option>
          </select>
        </div>
      </div>
