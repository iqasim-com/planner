...
const CreateInvoice: FC<Props> = ({show, handleClose}) => {
  ...
  return (
    ...
    >
      ...
      <div className='d-flex flex-column' id='kt_project_invoice_creator_modal'>
        <form>
          <Modal.Body>
                ...
                <div className='card'>
                  <div className='card-body p-12'>
                    ...
                    <div className='d-flex flex-column align-items-start flex-xxl-row'>
                      ...
                      >
                        {/* begin::Date */}
                        <div className='fs-6 fw-bolder text-gray-700 text-nowrap'>Date:</div>
                        {/* end::Date */}
                        {/* begin::Input */}
                        <div className='position-relative d-flex align-items-center w-150px'>
                          {/* begin::Datepicker */}
                          <input
                            className='form-control form-control-white fw-bolder pe-5'
                      ...
                      >
                        {/* begin::Date */}
                        <div className='fs-6 fw-bolder text-gray-700 text-nowrap'>Due Date:</div>
                        {/* end::Date */}
                        {/* begin::Input */}
                        <div className='position-relative d-flex align-items-center w-150px'>
                          {/* begin::Datepicker */}
                          ...
                          <tfoot>
                            <tr className='border-top border-top-dashed align-top fs-6 fw-bolder text-gray-700'>
                              <th className='text-primary'>
                                <button className='btn btn-link py-1' data-kt-element='add-item'>
                                  Add item
                                </button>
                              </th>
              ...
              <div className='flex-lg-auto min-w-lg-300px'>
                <div className='card'>
                  ...
                  >
                    ...
                    <div className='mb-10'>
                      {/* begin::Label */}
                      <label className='form-label fw-bolder fs-6 text-gray-700'>Currency</label>
                      {/* end::Label */}
                      {/* begin::Select */}
                      <select
                        name='currnecy'
                    ...
                    <div className='mb-0'>
                      ...
                      <div className='row mb-5'>
                        {/* begin::Col */}
                        <div className='col'>
                          <a href='#' className='btn btn-light btn-active-light-primary w-100'>
                            Preview
                          </a>
                        </div>
                        {/* end::Col */}
