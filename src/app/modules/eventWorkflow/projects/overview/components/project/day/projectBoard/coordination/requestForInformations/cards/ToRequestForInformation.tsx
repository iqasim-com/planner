...
const ToRequestForInformation: FC<Props> = ({
  icon,
  badgeColor,
  status,
  statusColor,
  ...
  return (
    <Link
      to='/projects/PIM/project/overview/days/day/coordination/request-for-information/overview'
      className='card border border-2 border-gray-100 bg-gray-100 border-hover'
    >
...
export {ToRequestForInformation}
