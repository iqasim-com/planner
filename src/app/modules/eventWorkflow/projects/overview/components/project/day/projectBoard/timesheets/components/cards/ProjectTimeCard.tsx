...
const ProjectTimeCard: FC<Props> = ({className}) => {
  return (
    <div className={`card ${className}`}>
          ...
          <table className='table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3'>
            ...
            <tbody>
              <tr>
                ...
                <td className='text-dark fw-bolder text-hover-primary fs-6'>Normal Time</td>
                <td className='text-dark fw-bolder text-hover-primary fs-6'>8</td>
                <td className='text-dark fw-bolder text-hover-primary fs-6'>8</td>
                <td className='text-dark fw-bolder text-hover-primary fs-6'>8</td>
                <td className='text-dark fw-bolder text-hover-primary fs-6'>12</td>
                <td className='text-dark fw-bolder text-hover-primary fs-6'>8</td>
                <td className='text-dark fw-bolder text-hover-primary fs-6'></td>
                <td className='text-dark fw-bolder text-hover-primary fs-6'></td>
                <td className='text-dark fw-bolder text-hover-primary fs-6'>44</td>
              </tr>
              ...
              <tr>
                ...
                <td className='text-dark fw-bolder text-hover-primary fs-6'>Paid Over Time</td>
                ...
                <td className='text-dark fw-bolder text-hover-primary fs-6'></td>
                <td className='text-dark fw-bolder text-hover-primary fs-6'></td>
                <td className='text-dark fw-bolder text-hover-primary fs-6'>9</td>
              </tr>
              ...
              <tr>
                ...
                <td></td>
                <td className='text-dark fw-bolder text-hover-primary fs-6'></td>
                <td className='text-dark fw-bolder text-hover-primary fs-6'>10</td>
                <td className='text-dark fw-bolder text-hover-primary fs-6'>10</td>
                <td className='text-dark fw-bolder text-hover-primary fs-6'>9</td>
                <td className='text-dark fw-bolder text-hover-primary fs-6'>15</td>
                <td className='text-dark fw-bolder text-hover-primary fs-6'>9</td>
                <td className='text-dark fw-bolder text-hover-primary fs-6'></td>
                <td className='text-dark fw-bolder text-hover-primary fs-6'></td>
                <td className='text-dark fw-bolder text-hover-primary fs-6'>53</td>
              </tr>
      ...
      <div className='card-footer d-flex justify-content-end py-3'>
        ...
        <button className='btn btn-white btn-active-light-primary me-2'>Save</button>
