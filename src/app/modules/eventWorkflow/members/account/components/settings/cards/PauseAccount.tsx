...
import {IPauseAccount, pauseAccount} from '../SettingsModel'
...
const PauseAccount: React.FC = () => {
  const [loading, setLoading] = useState(false)
  const formik = useFormik<IPauseAccount>({
    initialValues: {
      ...pauseAccount,
    },
    ...
    <div className='card'>
      ...
      >
        <div className='card-title m-0'>
          <h3 className='fw-bolder m-0'>Pause Account</h3>
        </div>
      </div>
            ...
            <div className='notice d-flex bg-light-warning rounded border-warning border border-dashed mb-9 p-6'>
              ...
              <div className='d-flex flex-stack flex-grow-1'>
                <div className='fw-bold'>
                  <h4 className='text-gray-800 fw-bolder'>You Are Pausing Your Account</h4>
                  <div className='fs-6 text-gray-600'>
                    For extra security, this requires you to confirm your email or phone number when
                    you reset you signr password.
                    <br />
