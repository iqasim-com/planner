...
const ProfileDetails: React.FC = () => {
  ...
  const [newInput, setNewInput] = useState<{type: string; value: string, placeholder: string}[]>([]);
  ...
  const  getLocation = () => {
    if (navigator.geolocation) {
      console.log('GEOO', navigator.geolocation.getCurrentPosition);
    } else {
  ...
  useEffect(() => {
    navigator.geolocation.getCurrentPosition((position) => {
      ...
      axios.get('http://ws.geonames.org/countryCode', {params: {
  ...
  /**
   * Function for deleting the input field added for the additional contact number
   * Expecting following
   * @param index 
   */
  ...
  /**
   * Function for choosing number type from dropdown, based on value
   * displaying the input field with specific placeholder
   * @param e any
   */
  const selectContactNumber = (e: any) => {
    let placeholder = '';
    switch (e.target.value) {
      case 'Phone-Number':
        placeholder = "Add personal contact";
        break;
      case 'Office-Number':
        placeholder = "Add office contact";
        break;
      case 'Desk-Number':
        placeholder = "Add your desk number";
        break;
      case 'Fax-Number':
          ...
          <div className='card-body border-top p-9'>
            {/* <div className='row mb-6'>
              ...
              <div className='col-lg-8'>
                <div
                  className='image-input image-input-outline d-flex flex-row align-items-start'
                ...
                >
                  ...
                  <div className='ms-3'>
                    <p className='w-75'>
                      Lorem ipsum dolor, sit amet consectetur adipisicing elit. Numquam quas fugiat atque ex fugit odio eius maiores, size: <span className='text-primary fw-bold'>200 x 200</span>
                    </p>
                    <button
                      className='btn btn-bg-light btn-active-color-primary position-relative cursor-pointer'
                      data-kt-menu-trigger='click'
                      data-kt-menu-placement='bottom-end'
                      data-kt-menu-flip='top-end'
                    >
                      <input type="file" className='position-absolute w-100 opacity-0 cursor-pointer h-100 top-0' />
                      Change Photo
                    </button>
                  </div>
                </div>
            ...
            <div className='row mb-6'>
              <div className='col-lg-12'>
                <div className='row'>
                  ...
                  <div className='col-lg-4 fv-row'>
                    <label className='required fw-bold fs-6 mb-2'>Middle Name</label>
                    <input
                      type='text'
                      className='form-control form-control-lg form-control-solid mb-3 mb-lg-0'
                      placeholder='First name'
              ...
              <div className='col-lg-8 fv-row'>
                <div className='d-flex mb-3'>
                  <PhoneInput
                    ...
                    inputComponent={() => {
                      return (
                        <input type="text" placeholder="Contact" className='form-control form-control-lg form-control-solid' />
                      )
                    }}
                    defaultCountry="US"
                    onChange={setValue}/>
            ...
            <div className='row mb-0'>
              ...
              <div className='col-lg-8 d-flex align-items-center'>
                <div className='form-check form-check-solid form-switch fv-row'>
                  ...
                  />
                  <label className='form-check-label ms-2 text-muted'>Ability to choose whether to receive marketing email or text messages.</label>
                </div>
              </div>
            </div>
          </div>
