                ...
                <div className='d-flex flex-wrap'>
                  ...
                  <div className='border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3'>
                    <div className='d-flex align-items-center'>
                      ...
                      />
                      <div className='fs-2 fw-bolder'>{projects.length}</div>
                    </div>
          ...
          <ul className='nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap'>
            <li className='nav-item'>
              <Link
                className={
                  ...
                  (location.pathname === '/members/account/overview' && 'active')
                }
                to='/members/account/overview'
              >
                Overview
              </Link>
            </li>
            <li className='nav-item'>
              <Link
                className={
                  `nav-link text-active-primary me-6 ` +
                  (location.pathname === '/members/account/settings' && 'active')
                }
                to='/members/account/settings'
              >
                Settings
              </Link>
            </li>
            ...
            <li className='nav-item'>
              <Link
                ...
                to='/members/account/subscription'
              >
                Subscription
              </Link>
            </li>
            <li className='nav-item'>
              <Link
                className={
                  `nav-link text-active-primary me-6 ` +
                  (location.pathname === '/members/account/authentication' && 'active')
                }
