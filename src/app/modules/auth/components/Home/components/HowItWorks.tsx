          ...
          <div className='col-md-4 px-5'>
            ...
            <div className='text-center mb-10 mb-md-0'>
              ...
              <div className='d-flex flex-center mb-5'>
                ...
                {/* end::Badge */}
                {/* begin::Title */}
                <div className='fs-5 fs-lg-3 fw-bolder text-dark'>Jane Miller</div>
                {/* end::Title */}
              </div>
              {/* end::Heading */}
              {/* begin::Description */}
          ...
          <div className='col-md-4 px-5'>
            ...
            <div className='text-center mb-10 mb-md-0'>
              ...
              <div className='d-flex flex-center mb-5'>
                ...
                {/* end::Badge */}
                {/* begin::Title */}
                <div className='fs-5 fs-lg-3 fw-bolder text-dark'>Setup Your App</div>
                {/* end::Title */}
              </div>
              {/* end::Heading */}
              {/* begin::Description */}
          ...
          <div className='col-md-4 px-5'>
            ...
            <div className='text-center mb-10 mb-md-0'>
              ...
              <div className='d-flex flex-center mb-5'>
                ...
                {/* end::Badge */}
                {/* begin::Title */}
                <div className='fs-5 fs-lg-3 fw-bolder text-dark'>Enjoy Nautica App</div>
                {/* end::Title */}
              </div>
              {/* end::Heading */}
              {/* begin::Description */}
