...
const PublicHeader = () => {
  return (
    <>
      <div
        className='landing-header bg-dark shadow mb-5'
        data-kt-sticky='true'
        ...
        <div className='container'>
          ...
          <div className='d-flex align-items-center justify-content-between'>
            ...
            <div className='d-flex align-items-center flex-equal'>
              ...
              {/* begin::Logo image */}
              <a href='/'>
                <h2 className='mb-0 text-primary'>EWF</h2>
              </a>
              {/* end::Logo image */}
            </div>
            {/* end::Logo */}
            ...
            <div className='flex-equal text-end ms-1'>
              <Link to={'/auth/login'} className='me-3 btn btn-outline-primary btn-outline btn-outline-dashed'>
                <i className='fa fa-sign-in'></i> Sign In
              </Link>
              <Link to={'/auth/registration'} className='btn btn-outline-info btn-active-dark btn-outline btn-outline-dashed'>
                <i className='fa fa-sign-up'></i> Register
              </Link>
            </div>
            {/* end::Toolbar */}
          </div>
