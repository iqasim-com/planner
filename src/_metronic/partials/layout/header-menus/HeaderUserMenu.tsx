...
import { logoutRequest } from '../../../../app/modules/redux/auth/authSlice'
  ...
  return (
    ...
    >
      <div className='menu-item px-3'>
        <div className='menu-content d-flex align-items-center px-3'>
          <div className='symbol symbol-50px me-5'>
            <img alt='Logo' src={userData.profilePictureUrl ? userData.profilePictureUrl : toAbsoluteUrl('/media/avatars/300-1.jpg')} />
          </div>
      ...
      <div className='menu-item px-5'>
        <Link to={'/members/account/overview'} className='menu-link px-5'>
          My Profile
        </Link>
      </div>
      ...
      <div className='menu-item px-5'>
        ...
        <a href='#' className='menu-link px-5'>
          ...
          <span className='menu-badge'>
            <span className='badge badge-light-danger badge-circle fw-bolder fs-7'>{projects.length}</span>
          </span>
        </a>
        </Link>
      </div>
